...
use slog::{LevelFilter, Logger, Streamer};
use slog::{OwnedKeyValueList, Record};
use slog_stdlog;

lazy_static! {
    static ref ATOMIC_DRAIN: AtomicSwitchCtrl = AtomicSwitchCtrl::new(slog::discard());
